...
public class LastWindowTest {
     ...
     *
     * When the agent monitoring period is set to 22s, running for
     * 12 seconds forces the thread to die right in the middle of a monitoring window.
     * This allows us to test and verify that JoularJX accurately tracks partial sub-samples and
     * estimates dead thread CPU time without underestimating energy or making static 10ms assumptions.
     *
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        }, "Worker-LastWindow"); //  A synthetic helper method generated by the Java compiler
